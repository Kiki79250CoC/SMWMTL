            ...
            Case True
                ...
                Select Case My.Settings.ADDITIONAL_TITLE_TEXT_TYPE
                    ...
                    Case 2
                        ...
                        Text = Text.Replace("$ABS", $"{My.Application.Info.AssemblyName}_{My.Resources.APP_CODENAME}_{My.Resources.APP_VERSION_COMPLETE}_x64_{My.Resources.BUILD_DATE_COMBINED}")
