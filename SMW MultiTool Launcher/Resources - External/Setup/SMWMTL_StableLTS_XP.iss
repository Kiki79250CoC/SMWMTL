...
#define MyAppVersion "2.10.1220.82"
#define MyShortAppVersion "2.10-LTS.13"
...
OutputBaseFilename=SMWMTL_{#MyShortAppVersion}_win32_XPInstaller
...
[Files]
Source: "S:\SMWMTL Maintenance\Compilation\LTS\CompExe86\SMWMTL.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "S:\SMWMTL Maintenance\Compilation\LTS\x86\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
