...
#define MyAppVersion "2.10.1210.26"
#define MyShortAppVersion "2.10-LTS.3"
#define MyAppPublisher "•••Kiki79250•••"
...
[Files]
Source: "D:\SMWMTL Maintenance\Compilation\LTS\CompExe64\SMWMTL.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\SMWMTL Maintenance\Compilation\LTS\x64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
