...
#End Region
    ...
    Private Sub Frm02_About_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        AppVersionStringLabel.Text = $"{My.Application.Info.AssemblyName}_{My.Resources.APP_CODENAME}_{My.Resources.APP_VERSION_COMPLETE}_x64_{My.Resources.BUILD_DATE_COMBINED}"
